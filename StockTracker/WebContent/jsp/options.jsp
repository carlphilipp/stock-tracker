			...
			<form id="modifyOptionId" name="modifyOptionId" autocomplete="on" action="add">
				<table>
					...
					<tr>
						...
						<input type="checkbox" id="autoUpdate" name="autoUpdate" onclick="showNextOrNot();" ${autoUpdate }/> Activate<br>
					...
					<tr>
						<td><input type="button" value="Modify" onclick="javascript:checkForm('modifyOptionId', 'modify', 'processSendOption', modifyOption);"> <input
