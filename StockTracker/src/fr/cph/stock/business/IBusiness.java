...
public interface IBusiness {
	 ...
	 *             the EquityException
	 */
	void createEquity(final int userId, final String ticker, final Equity equity) throws UnsupportedEncodingException,
			YahooException, EquityException;
	 ...
	 *             the YahooException
	 */
	void updateEquity(final int userId, final String ticker, final Equity equity) throws UnsupportedEncodingException,
			YahooException;
