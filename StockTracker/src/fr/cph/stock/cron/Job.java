...
public class Job {
	...
	public void run() throws SchedulerException {
		...
		Trigger triggerCurrency = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 55 * ? * MON-FRI")
		...
		Trigger triggerCac40 = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 15 18 ? * MON-FRI")
				.inTimeZone(TimeZone.getTimeZone("Europe/Paris")))
				.build();
		...
		Trigger triggerCac40Check = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 30 18-23 ? * MON-FRI")
				.inTimeZone(TimeZone.getTimeZone("Europe/Paris")))
				.build();
		...
		Trigger triggerSP500 = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 10 17 ? * MON-FRI")
		...
		Trigger triggerSP500Check = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 15 18-23 ? * MON-FRI")
				.inTimeZone(TimeZone.getTimeZone("America/New_York")))
				.build();
		sched.scheduleJob(jobSP500Check, triggerSP500Check);

		JobDetail jobCompanyNotRealTime = JobBuilder.newJob(CompanyNotRealTimeJob.class).withIdentity("jobCompanyNotRealTime", "company")
				.build();
		Trigger triggerCompanyNotRealTime = TriggerBuilder
				.newTrigger()
				.withIdentity("triggerCompanyNotRealTime", "company")
				.withSchedule(CronScheduleBuilder.cronSchedule("0 30 1-6 ? * *")
				.inTimeZone(TimeZone.getTimeZone("Europe/Paris")))
				.build();
		...
		Trigger triggerClean = TriggerBuilder
				...
				.withSchedule(CronScheduleBuilder.cronSchedule("0 30 0 ? * MON-FRI")
				.inTimeZone(TimeZone.getTimeZone("Europe/Paris")))
				.build();
		...
		Trigger triggerMysql = TriggerBuilder
				.newTrigger()
				.withIdentity("triggerMysql", "system")
