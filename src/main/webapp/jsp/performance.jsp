	...
	<div class="main">
		<div class="equities_container">
			<div class="floatLeft">
				...
				<br> from <fmt:formatDate value="${_from}" pattern="${user.datePatternWithoutHourMin }"/> to
				<fmt:formatDate value="${_to}" pattern="${user.datePatternWithoutHourMin }"/> [<a
...
<script type="text/javascript">
	...
	(function basic_time(container) {
		var <c:out value="${portfolio.timeChart.data}" escapeXml="false"/>,
		start = new Date(
